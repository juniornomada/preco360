export default async function handler(req, res) {
  ...
  const retry = req.query?.retry === "1" ? "&retry=1" : "";
  const target = mode === "crop"
    ? "https://hwpsnipdkwxvvjowomlo.supabase.co/functions/v1/extract-targeted-flyer-packshots?t=p360-crop-20260921-26-51b7ca" + retry
